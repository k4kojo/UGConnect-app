...
const AdminDashboard = () => {
  ...
  }, [data.adminDashboard, data.adminRecentActivity, data.notifications, fetchAdminDashboard, fetchAdminRecentActivity, fetchNotifications]);
  ...
  return (
    <>
      <TopLoadingBar loading={loading} colorClass="bg-blue-600" trackClass="bg-blue-200/50" />
