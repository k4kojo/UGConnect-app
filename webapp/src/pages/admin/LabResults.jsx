...
const LabResults = () => {
  ...
  const handleNewTest = () => {
    // Navigate to new test form or open modal
    toast.info('New test functionality coming soon');
  };

  const handlePrintResult = (result) => {
    toast.info(`Printing result for ${result.testName}`);
  };

  const handleDownloadResult = (result) => {
    toast.info(`Downloading result for ${result.testName}`);
  };
    ...
    },
    {
      ...
      render: (result) => (
        <div className="text-sm text-gray-900">
          {result.orderedByName || 'Unknown Staff'}
        </div>
      )
    },
    {
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{selectedResult.orderedByName}</p>
                  </div>
                  <div>
