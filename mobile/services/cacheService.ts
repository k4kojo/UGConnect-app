...
export const CACHE_KEYS = {
  ...
  MEDICATION_DETAILS: (id: string) => `medication_${id}`,
  MEDICATION_LOGS: (id: string) => `medication_logs_${id}`,
  MEDICATION_ADHERENCE: (id: string) => `medication_adherence_${id}`,
  MEDICATION_REMINDERS: (id: string) => `medication_reminders_${id}`,
