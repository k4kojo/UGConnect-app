...
function AppRoutes() {
  return (
    <Routes>
      ...
      {/* Video Session - No Layout for fullscreen experience */}
      <Route
      ...
      <Route
        path="/unauthorized"
        element={<ComingSoonPage title="Unauthorized: Access denied" />}
      />
      <Route path="*" element={<DefaultRedirect />} />
    </Routes>
  );
