    ...
    if (user?.role === 'doctor') {
      ...
      const settingsItems = [
        { 
          ...
          hasDropdown: true,
          isOpen: settingsOpen,
          isActive: location.pathname.includes('/doctor/settings') || location.pathname === '/doctor/availability',
          subItems: [
            { name: 'profile', path: '/doctor/settings/profile' },
            { name: 'security', path: '/doctor/settings/security' },
            { name: 'notifications', path: '/doctor/settings/notifications' },
            { name: 'appearance', path: '/doctor/settings/appearance' },
            { name: 'doctor settings', path: '/doctor/settings/doctor' },
