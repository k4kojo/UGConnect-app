...
export const prescriptionsService = {
  ...
  // Create direct prescription (without appointment requirement)
  createDirectPrescription: async (prescriptionData) => {
    try {
      const response = await api.post('/prescriptions/direct', prescriptionData);
      return response.data;
    } catch (error) {
